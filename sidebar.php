<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
    <a class="sidebar-brand brand-logo" href="index.php"><img src="assets/coronafree/template/assets/images/logo.svg" alt="logo" /></a>
    <a class="sidebar-brand brand-logo-mini" href="index.php"><img src="assets/coronafree/template/assets/images/logo-mini.svg" alt="logo" /></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" href="assets/coronafree/template/pages/charts/chartjs.html">
        <span class="menu-icon">
